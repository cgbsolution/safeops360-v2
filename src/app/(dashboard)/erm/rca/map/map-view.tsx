...
function CauseNode({ data }: { data: any }) {
  return (
    <Card className="rounded-lg border-2 border-slate-900 bg-slate-900 px-3 py-2 text-white shadow-md">
...
function RiskNode({ data }: { data: any }) {
  ...
  return (
    <Card className="rounded-lg border-2 px-3 py-2 text-white shadow-md" style={{ backgroundColor: bg, borderColor: "rgba(255,255,255,0.5)" }}>
    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <SelectField
          ...
          placeholder="Top recurring drivers"
      ...
      {graph.nodes.length === 0 ? (
        ...
        <Card className="h-[640px] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-none">
          <ReactFlowProvider>
            <ReactFlow
              nodes={nodes}
              edges={edges}
