...
const EQUIPMENT_DEFS = [
  { idx: "01", name: "ClO₂ Dosing System — Bleach Plant", category: "PROCESS_EQUIPMENT", sub: "Chemical Dosing", criticality: "A", freq: "MONTHLY", make: "Grundfos", model: "DME 60-10", serial: "GFD-2021-4421", mfr: "Grundfos A/S" },
  { idx: "02", name: "EOT Crane 5T — Paper Machine Bay", category: "CRANE", sub: "Overhead EOT Crane", criticality: "A", freq: "WEEKLY", make: "Electromech", model: "EOT-5T-20M", serial: "EM-OHC-2019-1143", mfr: "Electromech Industries" },
  ...
  { idx: "07", name: "Fork Lift Truck 3T — FLT-01 (Reel Handling)", category: "MOBILE_EQUIPMENT", sub: "Forklift", criticality: "B", freq: "DAILY", make: "Godrej", model: "EFG-3T", serial: "GDJ-FLT-2022-0441", mfr: "Godrej Material Handling" },
  ...
  { idx: "09", name: "Stock Chest Agitator SC-201 (Pulp Stock)", category: "PRESSURE_VESSEL", sub: "Process Vessel", criticality: "A", freq: "MONTHLY", make: "Bharat Heavy Electricals", model: "BHE-PV-2000-14B", serial: "BHEL-PV-2016-0077", mfr: "BHEL" },
  { idx: "10", name: "Electrical MCC Panel — Paper Machine Drive", category: "ELECTRICAL", sub: "Motor Control Centre", criticality: "A", freq: "MONTHLY", make: "L&T", model: "3W3-MCC-400A", serial: "LT-MCC-2021-5512", mfr: "Larsen & Toubro" },
];
  ...
  for (const eq of EQUIPMENT_DEFS) {
    ...
    const e = await prisma.equipment.create({
      data: {
        ...
        location: `Pulp Mill — ${P === "NW" ? "North Paper Mill" : "South Kraft & Board Mill"}`,
