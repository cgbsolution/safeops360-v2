  ...
  const MOCS = [
    {
      ...
      title: "Replacement of ClO₂ Bleaching Dosing Valves — Corrosion-Resistant Upgrade",
      description: "Replace 6 cast-iron isolation valves in the bleach plant chlorine dioxide (ClO₂) dosing system with titanium-lined valves to eliminate recurrence of the corrosion-related gas leak (ref: CAPA-NW-DEMO-001 corrective action).",
      ...
      affectedProcesses: ["ClO₂ Dosing", "Bleaching"],
      affectedEquipment: [`EQ-${P}-DEMO-01`],
      businessJustification: "Existing CI valves have shown corrosion failures in ClO₂ service. Two gas exposure incidents in 18 months. Upgrading to titanium-lined valves eliminates root cause and meets PESO statutory requirements.",
      expectedBenefits: "Zero recurrence of ClO₂ gas leaks from valve corrosion. PESO compliance. Maintenance interval extended from 6 months to 24 months.",
      costEstimate: 285000,
      pssrRequired: true,
      pssrOutcome: "go",
      ...
      dependentRecords: [
        ...
        { recordType: "inspection_schedule", recordReference: "ClO₂ Dosing Monthly Inspection", impactType: "must_update", impactDescription: "Inspection frequency changed from monthly to quarterly for corrosion checks.", updateStatus: "completed" },
        { recordType: "sop", recordReference: "SOP-CHEM-002 ClO₂ Dosing Operations", impactType: "must_update", impactDescription: "SOP updated for new valve type — operating torque and LOTO points changed.", updateStatus: "completed" },
      ],
      stateTransitions: [
    ...
    },
    {
      ...
      description: "Replace sodium sulphite oxygen scavenger with DEHA (diethylhydroxylamine) in the power & steam plant boiler feed water treatment to improve corrosion protection and reduce chemical inventory risk.",
    ...
    },
    {
      ...
      description: "Change paper machine operations from a rotating 4-shift pattern (Day/Eve/Night/Off) to a fixed 3-shift schedule to reduce fatigue incidents and improve handover consistency.",
      ...
      affectedProcesses: ["Paper Machine Operations", "Shift Management"],
      affectedEquipment: [],
      ...
      dependentRecords: [
        ...
        { recordType: "role_definition", recordReference: "Paper Machine Operator Role Profile", impactType: "must_update", impactDescription: "Role profile updated to reflect fixed shift hours and responsibilities.", updateStatus: "in_progress" },
      ],
      stateTransitions: [
    ...
    },
    {
      ...
      description: "Replace 4 diesel-powered reel-handling forklifts with lithium-ion battery electric models. Includes installation of charging infrastructure, ventilation review, and fire protection assessment.",
      origin: "operational_request",
      stepsCompleted: 0,
      ...
      businessJustification: "Diesel forklifts contribute to indoor air quality issues in the enclosed reel & ream warehouse. Electrification aligns with company sustainability targets and eliminates diesel emission risk in classified hazardous area.",
