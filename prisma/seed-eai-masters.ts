...
const REGULATIONS = [
  ...
  { code: "CPCB_INDUSTRY_STANDARDS", name: "CPCB Industry-Specific Emission and Effluent Standards", jurisdiction: "INDIA", authority: "CPCB", description: "Pulp & paper, large pulp & paper, and agro-residue paper mill industry-specific limits", sortOrder: 90 },
...
const ASPECTS = [
  // AIR
  { code: "AIR_STACK_PM",          categoryCode: "AIR_EMISSIONS", name: "Stack particulate matter emissions", description: "Solid particles (SPM) emitted from process stacks (recovery boiler, multi-fuel boiler, lime kiln, etc.)", typicalReceptors: ["AIR","COMMUNITY","EMPLOYEES"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS","EPA_1986"], typicallySignificant: true },
  ...
  { code: "RES_RAW_MATERIAL",      categoryCode: "RESOURCE_CONSUMPTION", name: "Raw material consumption", description: "Consumption of wood, bagasse, recycled waste paper and pulping chemicals", typicalReceptors: ["BIODIVERSITY","SOIL"], typicalRegulations: ["EPA_1986","ISO_14001_2015"], typicallySignificant: false },
  ...
  { code: "NOISE_BLAST",           categoryCode: "NOISE_VIBRATION", name: "Impulse / pressure-release noise", description: "Steam venting, safety-valve lift, soot-blowing, pressure release", typicalReceptors: ["COMMUNITY","EMPLOYEES","BIODIVERSITY"], typicalRegulations: ["NOISE_RULES_2000"], typicallySignificant: true },
  ...
  // AIR — EA codes
  { code: "EA-AIR-001", categoryCode: "AIR_EMISSIONS", name: "Particulate matter (SPM/PM10/PM2.5) from boiler & lime-kiln stacks",
    description: "Solid particulate emissions from recovery boiler, multi-fuel boiler and lime-kiln stacks entering ambient air.", typicalReceptors: ["AIR","COMMUNITY","EMPLOYEES"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS","EPA_1986"], typicallySignificant: true },
  { code: "EA-AIR-002", categoryCode: "AIR_EMISSIONS", name: "SO2 emissions from boiler & recovery furnace combustion",
    description: "Sulphur dioxide from combustion of sulphur-containing fuels and black-liquor firing in the recovery boiler.", typicalReceptors: ["AIR","COMMUNITY"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: false },
  { code: "EA-AIR-003", categoryCode: "AIR_EMISSIONS", name: "NOx emissions from boiler & lime-kiln combustion",
    description: "Nitrogen oxides from high-temperature combustion in boilers and the lime kiln.", typicalReceptors: ["AIR","COMMUNITY"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: false },
  ...
  { code: "EA-AIR-005", categoryCode: "AIR_EMISSIONS", name: "VOC / chlorine-dioxide emissions from bleach plant",
    description: "Volatile organic compound and chlorine-dioxide vent emissions from bleaching and coating operations.", typicalReceptors: ["AIR","COMMUNITY","EMPLOYEES"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: true },
  { code: "EA-AIR-006", categoryCode: "AIR_EMISSIONS", name: "Chlorine / acid gas emissions from bleach plant",
    description: "Chlorine and acid gases emitted from bleaching, chemical preparation, or chlorine-dioxide generation.", typicalReceptors: ["AIR","COMMUNITY","EMPLOYEES"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: false },
  { code: "EA-AIR-007", categoryCode: "AIR_EMISSIONS", name: "Fugitive dust from wood-chip & lime-mud handling, storage, transfer",
    description: "Uncontrolled dust from wood-chip stockpiles, conveyors, lime-mud and fly-ash transfer points.", typicalReceptors: ["AIR","COMMUNITY","EMPLOYEES"], typicalRegulations: ["AIR_ACT_1981","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: true },
  { code: "EA-AIR-008", categoryCode: "AIR_EMISSIONS", name: "Odour (TRS) from pulping, recovery, ETP, or waste storage",
    description: "Total reduced sulphur (TRS) and other odorous compounds from pulping, chemical recovery, ETP, or waste storage reaching community.", typicalReceptors: ["AIR","COMMUNITY"], typicalRegulations: ["AIR_ACT_1981","EPA_1986"], typicallySignificant: false },
  ...
  // WATER — EA codes
  { code: "EA-WATER-001", categoryCode: "WATER_DISCHARGE", name: "Bleach-plant & process effluent discharge to ETP (COD, BOD, AOX, colour)",
    description: "Bleach-plant and pulp/paper process effluent (COD, BOD, AOX, colour, TSS) discharged to effluent treatment plant.", typicalReceptors: ["SURFACE_WATER","ECOSYSTEM"], typicalRegulations: ["WATER_ACT_1974","CPCB_INDUSTRY_STANDARDS"], typicallySignificant: true },
  ...
  { code: "EA-WATER-005", categoryCode: "WATER_DISCHARGE", name: "Black liquor / chemical / oil spill to drainage and water body",
    description: "Accidental black-liquor, chemical or oil release entering plant drainage and reaching water body.", typicalReceptors: ["SURFACE_WATER","GROUND_WATER","ECOSYSTEM"], typicalRegulations: ["WATER_ACT_1974","EPA_1986"], typicallySignificant: true },
  ...
  { code: "EA-WASTE-001", categoryCode: "WASTE_GENERATION", name: "Hazardous waste generation — process byproducts",
    description: "Hazardous waste generated as byproducts of pulping, bleaching and chemical-recovery processes.", typicalReceptors: ["SOIL","COMMUNITY","ECOSYSTEM"], typicalRegulations: ["HAZARDOUS_WASTE_RULES_2016","EPA_1986"], typicallySignificant: true },
  ...
  { code: "EA-WASTE-007", categoryCode: "WASTE_GENERATION", name: "Solid waste — ETP sludge, lime-mud, fly-ash and general waste",
    description: "ETP primary/biological sludge, lime-mud, boiler fly-ash and non-hazardous general waste from process and welfare areas.", typicalReceptors: ["SOIL","COMMUNITY"], typicalRegulations: ["EPA_1986"], typicallySignificant: false },
  ...
  { code: "EA-RESRC-003", categoryCode: "RESOURCE_CONSUMPTION", name: "High fresh water consumption — pulping, washing, cooling, domestic",
    description: "Total fresh water withdrawn for pulping, stock washing, paper-machine, cooling and domestic uses.", typicalReceptors: ["SURFACE_WATER","GROUND_WATER","COMMUNITY"], typicalRegulations: ["WATER_ACT_1974","EPA_1986"], typicallySignificant: true },
  { code: "EA-RESRC-004", categoryCode: "RESOURCE_CONSUMPTION", name: "Raw material consumption — wood, bagasse, recycled fibre",
    description: "Consumption of wood chips, bagasse, recycled waste paper and pulping chemicals for paper manufacturing.", typicalReceptors: ["BIODIVERSITY","SOIL"], typicalRegulations: ["EPA_1986","ISO_14001_2015"], typicallySignificant: false },
