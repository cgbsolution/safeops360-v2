...
const STUDIES = [
  {
    seq: "001", title: "Dye House Reactive-Dye Chemical Dosing — Comprehensive HIRA",
    scope: "PROCESS", status: "ACTIVE", stepsCompleted: 99,
    description: "Full hazard identification and risk assessment for the dye house reactive-dye and dye-bath chemical dosing process including receipt, storage, handling, and dosing into the soft-flow dyeing vessels. Covers all personnel exposure scenarios under routine, non-routine, and emergency conditions.",
    processCode: "PROC-CHG-DOSE-001",
    reviewFreq: "ANNUAL",
    entries: [
      { activity: "Unloading dye chemicals / reactive-dye drums from delivery vehicle at dye house", routine: "NON_ROUTINE", freq: "WEEKLY", persons: 3, initL: 3, initS: 5, resL: 2, resS: 4,
      ...
      { activity: "Storage in dye house dye-chemical store cage", routine: "ROUTINE", freq: "DAILY", persons: 5, initL: 2, initS: 5, resL: 1, resS: 5,
      ...
      { activity: "Connecting drum to dye-bath dosing line (header change)", routine: "NON_ROUTINE", freq: "WEEKLY", persons: 2, initL: 3, initS: 5, resL: 1, resS: 4,
      ...
      { activity: "Routine dosing into dyeing vessels — pump running", routine: "ROUTINE", freq: "CONTINUOUS", persons: 8, initL: 2, initS: 4, resL: 1, resS: 3,
      ...
      { activity: "Dye-chemical spill / vapour release response in dye house / ERP activation", routine: "EMERGENCY", freq: "RARE", persons: 15, initL: 2, initS: 5, resL: 1, resS: 4,
      ...
      { activity: "Drum replacement and empty drum despatch", routine: "NON_ROUTINE", freq: "WEEKLY", persons: 2, initL: 2, initS: 4, resL: 1, resS: 3,
  ...
  },
  {
    ...
    description: "Hazard identification for all hot work activities (cutting, welding, grinding, brazing) performed across the garment unit. Covers all work areas including the knitting section, boiler house, sewing / finishing hall, maintenance workshop, and restricted zones.",
    processCode: "ACT-HOT-WORK-002",
    reviewFreq: "ANNUAL",
    entries: [
      { activity: "Gas cutting and oxy-acetylene welding in knitting section / boiler house area", routine: "NON_ROUTINE", freq: "WEEKLY", persons: 3, initL: 4, initS: 4, resL: 2, resS: 3,
      ...
      { activity: "Hot work near dye-chemical / chemical storage area (special conditions)", routine: "NON_ROUTINE", freq: "MONTHLY", persons: 2, initL: 4, initS: 5, resL: 1, resS: 4,
        hazardCodes: ["FIRE_HOT_WORK_IGNITION", "CHEM_FLAMMABLE_SPILL"],
  ...
  {
    seq: "003", title: "Confined Space Entry — Dye Vessels, Tanks & ETP HIRA",
    scope: "ACTIVITY", status: "APPROVED", stepsCompleted: 5,
    description: "Systematic hazard analysis for confined space entry into all dyeing vessels, soft-flow dye machines, chemical mixing tanks, ETP sumps, and pits across the unit. Covers atmospheric testing, entry procedures, rescue, and standby requirements.",
    ...
    entries: [
      ...
      { activity: "Entry into dyeing vessels / mixing tanks (dye & chemical residues)", routine: "NON_ROUTINE", freq: "QUARTERLY", persons: 3, initL: 3, initS: 5, resL: 1, resS: 4,
        hazardCodes: ["CONFINED_OXYGEN_DEFICIENCY", "CHEM_TOXIC_INHALATION"],
        controlCodes: ["CTRL_PTW_CONFINED", "CTRL_LOTO"],
        regRef: "IS 4167 — confined space rescue", group: "Process Vessel Entry" },
      { activity: "Entry into ETP sumps and effluent pits", routine: "NON_ROUTINE", freq: "MONTHLY", persons: 2, initL: 3, initS: 4, resL: 1, resS: 3,
  ...
  },
  {
    ...
    description: "Hazard identification for overhead crane and EOT crane operations in the knitting hall and fabric / yarn store area, including fabric-roll lifting, slinging, travel, and maintenance. Covers operator, rigger, and ground personnel scenarios.",
