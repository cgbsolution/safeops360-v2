...
async function main() {
  ...
  const VENDORS: VSpec[] = [
    ...
    { code: "VEN-0004", legalName: "GreenFibre Cotton Yarn & Fabric Ltd", category: "Raw material", criticality: "CRITICAL", tier: "TIER_1", site: null, owner: meera, spend: 16 * CR, status: "APPROVED", riskRaws: [2, 3, 3, 2, 2, 3], esgRaws: [3, 3, 3, 3, 3], links: ["0006"] },
    ...
    { code: "VEN-0010", legalName: "Page Industries Calibration Labs", category: "Calibration", criticality: "ROUTINE", tier: "TIER_3", site: null, owner: suresh, spend: 0.8 * CR, status: "APPROVED", riskRaws: [1, 2, 1, 2, 1, 1] },
  ...
  const POLICIES: PSpec[] = [
    { code: "POL-0001", name: "Industrial All-Risk — North & South Garment Unit", type: "PROPERTY_FIRE", insurer: "Bharat General Insurance", broker: "Marsh India", num: "IAR/2026/4471", sites: [nw.id, sw.id], sumInsured: 450 * CR, premium: 1.8 * CR, deductible: 25 * L, startDays: 200, endDays: 165, risks: ["0011"], procs: ["BP-0005"], exclusions: ["War & terrorism (separate add-on)", "Wear and tear"] },
