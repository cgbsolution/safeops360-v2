  ...
  return [
    {
      ...
      fields: {
        ...
        designation: "Dye House Operator",
        natureOfInjury: "Chemical exposure — bleaching agent (hydrogen peroxide / scouring chemical) vapour, first aid administered",
        bodyPartAffected: "Respiratory tract (mild)",
        locationOfAccident: "Dye House — Chemical Dosing Station",
  ...
  return [
    {
      ...
      fields: {
        ...
        workerBreakdown: [
          { department: "Sewing Line Operations", workers: 8, overtimeHours: 64 },
    ...
    },
    {
      ...
      fields: {
        ...
        workerBreakdown: [
          { department: "Sewing Line Operations", workers: 8, overtimeHours: 48 },
    ...
    },
    {
      ...
      fields: {
        ...
        workerBreakdown: [
          { department: "Sewing Line Operations", workers: 8, overtimeHours: 80 },
  ...
  return [
    {
      ...
      fields: {
        ...
        department: "Sewing Line Operations",
        dateOfJoining: daysAgo(730).toISOString().split("T")[0],
        natureOfWork: "Operating single-needle lockstitch and overlock sewing machines on the stitching line",
    ...
    },
    {
      ...
      fields: {
        ...
        natureOfWork: "In-process apparel testing — fabric GSM, bursting strength, colour fastness; laboratory analysis, deviation management",
        shiftType: "Day shift",
  ...
  return [
    {
      ...
      fields: {
        ...
        natureOfWork: "Annual Turnaround — Boiler House & Dye Vessel Cleaning",
        periodOfWork: { from: daysAgo(180).toISOString().split("T")[0], to: daysAgo(150).toISOString().split("T")[0] },
        numberOfContractWorkers: 22,
        principalEmployer: `Page Industries ${P === "NW" ? "North Garment Unit" : "South Garment Unit"}`,
    ...
    },
    {
      ...
      fields: {
        ...
        natureOfWork: "Civil repairs and painting — Knitting Section Block",
